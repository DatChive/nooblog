...
var HeaderActions = function HeaderActions() {
  ...
  this.generateActions('updateConnections');
};
...
var HomeActions = function () {
  function HomeActions() {
    ...
    this.generateActions('getPostsSuccess', 'getPostsFail');
  }
  ...
  _createClass(HomeActions, [{
    ...
    value: function getPosts() {
      ...
      $.ajax({ url: '/api/posts' }).done(function (data) {
        ...
        _this.actions.getPostsSuccess(data);
      }).fail(function (jqXhr) {
        console.log("fail");
        _this.actions.getPostsFail(jqXhr.responseJSON.message);
      });
    }
  }]);
...
var NewPostActions = function () {
  function NewPostActions() {
    _classCallCheck(this, NewPostActions);

    this.generateActions('invalidTitle', 'updateTitle', 'invalidBody', 'updateBody', 'newPostSuccess', 'newPostFail');
  }

  _createClass(NewPostActions, [{
    key: 'newPost',
    value: function newPost(title, body) {
      var _this = this;
      ...
      $.ajax({
        ...
        _this.actions.newPostSuccess(data.message);
      }).fail(function (jqXhr) {
        _this.actions.newPostFail(jqXhr.responseJSON.message);
      });
    }
  }]);
...
exports.default = _alt2.default.createActions(NewPostActions);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h1',
              null,
              'Footer. TODO: Find something useful to put here.'
            )
          )
        )
      );
...
},{"../stores/FooterStore":13,"react":"react"}],8:[function(require,module,exports){
'use strict';
  ...
  _createClass(Header, [{
    ...
    value: function componentDidMount() {
      ...
      socket.on('connections', function (data) {
        _HeaderActions2.default.updateConnections(data);
      });
    }
  }, {
    key: 'componentWillUnmount',
...
},{"../actions/HeaderActions":2,"../stores/HeaderStore":14,"react":"react","react-router":"react-router"}],9:[function(require,module,exports){
'use strict';
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      _HomeActions2.default.getPosts();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
    ...
    value: function render() {
      var postNodes = this.state.posts.map(function (post, index) {
        return _react2.default.createElement(
          'div',
          { key: post.title, className: 'list-group-item animated fadeIn' },
          _react2.default.createElement(
            'div',
            { className: 'media' },
            _react2.default.createElement('span', { className: 'position pull-left' }),
            _react2.default.createElement(
              'div',
...
},{"../actions/HomeActions":3,"../stores/HomeStore":15,"react":"react"}],10:[function(require,module,exports){
'use strict';
...
var _NewPostStore = require('../stores/NewPostStore');

var _NewPostStore2 = _interopRequireDefault(_NewPostStore);

var _NewPostActions = require('../actions/NewPostActions');

var _NewPostActions2 = _interopRequireDefault(_NewPostActions);
...
var NewPost = function (_React$Component) {
  ...
  function NewPost(props) {
    ...
    _this.state = _NewPostStore2.default.getState();
    _this.onChange = _this.onChange.bind(_this);
    return _this;
  }
  ...
  _createClass(NewPost, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _NewPostStore2.default.listen(this.onChange);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _NewPostStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    value: function onChange(state) {
    ...
    value: function handleSubmit(event) {
      ...
      if (!title) {
        _NewPostActions2.default.invalidTitle();
        this.refs.titleTextField.getDOMNode().focus();
      }

      if (!body) {
        _NewPostActions2.default.invalidBody();
      }

      if (title && body) {
        _NewPostActions2.default.newPost(title, body);
      }
    }
  }, {
    key: 'render',
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'titleTextField', value: this.state.title,
                      onChange: _NewPostActions2.default.updateTitle, autoFocus: true })
                  ),
                  _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'bodyTextField', rows: '3', value: this.state.body,
                      onChange: _NewPostActions2.default.updateBody, autoFocus: true })
                  ),
                  _react2.default.createElement(
                    'button',
...
},{"../actions/NewPostActions":4,"../stores/NewPostStore":16,"react":"react"}],11:[function(require,module,exports){
'use strict';
...
},{"./components/App":6,"./components/Home":9,"./components/NewPost":10,"react":"react","react-router":"react-router"}],13:[function(require,module,exports){
'use strict';
...
var HeaderStore = function () {
  ...
  _createClass(HeaderStore, [{
    key: 'onUpdateConnections',
    value: function onUpdateConnections(data) {
...
},{"../actions/HeaderActions":2,"../alt":5}],15:[function(require,module,exports){
'use strict';
...
var HomeStore = function () {
  ...
  _createClass(HomeStore, [{
    key: 'onGetPostsSuccess',
    value: function onGetPostsSuccess(data) {
      this.posts = data;
    }
  }, {
    key: 'onGetPostsFail',
    value: function onGetPostsFail(errorMessage) {
...
var NewPostStore = function () {
  function NewPostStore() {
    _classCallCheck(this, NewPostStore);

    this.bindActions(_NewPostActions2.default);
    this.title = '';
    this.body = '';
  ...
  _createClass(NewPostStore, [{
    key: 'onNewPostSuccess',
    value: function onNewPostSuccess(successMessage) {
      toastr.clear();
    ...
    key: 'onNewPostFail',
    value: function onNewPostFail(errorMessage) {
      toastr.clear();
...
exports.default = _alt2.default.createStore(NewPostStore);

},{"../actions/NewPostActions":4,"../alt":5}],17:[function(require,module,exports){
